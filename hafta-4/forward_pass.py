...
W1 = torch.randn((b,200), generator=g) * (5/3) / (b**0.5)
...
#train ---> 2.112308979034424
#develop ---> 2.156257152557373

#düzenlenmeden önce başlangıç loss 21.0983 sonra 3.8490

## düzenlenmiş loss için 
#train ---> 2.0738046169281006
#develop ---> 2.1384427547454834

#tanh saturasyon önelenmesi sonrası
#train ---> 2.038963556289673
#develop ---> 2.105384349822998
